		   ...
		   <div class="box_wrapper"><h1>Car Brands</h1></div>
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					<img src="images/dummycar.jpg" alt="" style="width: 375px; height: 210px;"/>
					<div class="grid_desc">
						<p class="title">Occasions</p>
					</div>
					<div class="Details">
				     <a href="occasions.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
				
				
				 <div class="col_1_of_4 span_1_of_4">
					<img src="images/lexus.jpg" alt="" style="width: 375px; height: 210px;"/>
					<div class="grid_desc">
						<p class="title">Lexus</p>
					</div>
					<div class="Details">
				     <a href="Lexus.php" title="Lorem ipsum dolor sit amet, consect etuer" class="button">cars<span></span></a></div>
				</div>
